...
def subscriptions(request):
    subscriptions_form = forms.UserFollowsForm()
    subscriptions_objects = UserFollows.objects.all()

    print('Number of subscriptions objects:', subscriptions_objects.count())
...
@login_required
def show_post(request, ticket_id):
